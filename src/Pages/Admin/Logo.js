...
const Logo = () => {
    ...
    return (
        ...
        <HeaderBottom></HeaderBottom>
            ...
            <section id="services" class="services-area pt-120 pb-90 fix mt-5 vh-100 mb-5" >
                <div class="container">
                    <div class="row">
                                ...
                                <>
                                    {
                                        logo.map(c =>
                                            logo.map(c =>
                                                <Link className='btn btn_dark px-4 py-3' to={`/admin/edit-logo/${c._id}`}> Please Edit Your Logo</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleLogo}>
                                    ...
                                    <div className="col-lg-12 col-md-12 mb-3">
                                        ...
                                        <div class="slider-btn">
                                            <button class="btn btn_dark px-4 py-3" data-animation="fadeInRight" data-delay=".8s">Update Your Logo</button>
                                        </div>
                                    </div>
